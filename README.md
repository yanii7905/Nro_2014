<p align="center">
  <a href="https://github.com/yanii7905/Nro_2014">
  ...
  <h1 align="center">NRO - 2014 (Gốc - Bản Kinh Doanh)</h1>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/yanii7905/Nro_2014/issues">Báo lỗi / Đóng góp</a>
  </p>
</p>

![Repo Size](https://img.shields.io/github/repo-size/yanii7905/Nro_2014?color=blue&style=flat-square)
![Languages](https://img.shields.io/github/languages/count/yanii7905/Nro_2014?style=flat-square)
...
- Truy cập vào `phpMyAdmin`, tạo mới một cơ sở dữ liệu (Database) với tên `b`.
- Tiến hành **Import** file cơ sở dữ liệu (`.sql`) đi kèm vào database vừa tạo.

### Bước 3: Khởi động Server
- Nhấp đúp chuột vào file `Run.bat` nằm trong thư mục **Sever**
**Lưu Ý:** Phải mở Apache và MySQL trong XAMPP trước rồi mới chạy Sever

### Bước 4: Trải nghiệm game
- Truy cập vào đường dẫn thư mục `AppLocal/srcnrofree.online.exe` để mở Client và bắt đầu bước chân vào thế giới Ngọc Rồng!
...
* Mọi đóng góp hoặc báo lỗi xin vui lòng tạo [Issue](https://github.com/yanii7905/Nro_2014/issues) để được hỗ trợ.